...
public class RobotMap {
	...
	// Joystick ports
	public static int leftJoyPort = 0; // Joystick can be found on this port.
										// The ports aren't physical plugs
	public static int rightJoyPort = 1; // But rather decided from the drivers
										// station by the drivers
	...
	public static int udDistance = 13; // distance for UltraDrive, pointless if
										// it's less than 12 for now
	...
	/**
	 * Called at the beginning of the program and whenever there is a change on
	 * the Shuffleboard
	 */
